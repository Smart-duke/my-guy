...
const Explore = () => {
  return (
    <div className='explore'>
        ...
        <h2>Explore the largest digital marketplace to discover the perfect craft skills.</h2>
        </div>
        ...
        <div className="reasons">
            ...
            <Link to="/"><button className='explore-btn'>Download to get started</button></Link>
        </div>

        <img src={HappyCustomers} alt=""  className='btm-img'/>
        <img src={Welder} alt="a welder doing his job" className='' />
        </div>
